...
object ServiceInjector {
    ...
    init {
        ...
        add(FavoriteService::class) {
            FavoriteService(resolve(FavoriteRequest::class))
        }
    ...
    fun resolve(lifeCycleService: LifeCycleService, view: PostListPresenter.View): PostListPresenter {
        return PostListPresenter(view, resolve(TagService::class), resolve(ProfileService::class), lifeCycleService, resolve(LikeDislikeService::class), resolve(FavoriteService::class))
    }
